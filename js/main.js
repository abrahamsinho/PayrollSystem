...
function mostrarFormularioTemporal() {
    app.innerHTML = `
        <section class="seccion">
            ...
            <p>
                Salario mensual durante el periodo establecido en el contrato.
            ...
            <form id="formTemporal" class="formulario">
                <div class="campo">
                    <label for="nombre">Nombre del empleado:</label>
                    <input type="text" id="nombre" placeholder="Ejemplo: Juan Martínez" required>
                </div>
    ...
    document.getElementById("formTemporal").addEventListener("submit", manejarFormularioTemporal);
}
...
function mostrarResultadoTemporal(empleado) {
    ...
    resultado.innerHTML = `
        <div class="resultado">
            ...
            <p><strong>Duración del contrato:</strong> ${empleado.calcularDuracionContratoDias()} día(s)</p>
            ...
            <button id="btnReiniciarTemporal" class="btn-reiniciar" type="button">Realizar otro cálculo</button>
        </div>
    `;

    document.getElementById("btnReiniciarTemporal").addEventListener("click", mostrarFormularioTemporal);
}
